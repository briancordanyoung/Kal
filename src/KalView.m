...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
  ...
  UIImageView *backgroundView = [[UIImageView alloc] initWithImage:[KalImageManager imageNamed:@"kal_grid_background.png"]];
  ...
  [previousMonthButton setImage:[KalImageManager imageNamed:@"kal_left_arrow.png"] forState:UIControlStateNormal];
  ...
  headerTitleLabel.textColor = [UIColor colorWithPatternImage:[KalImageManager imageNamed:@"kal_header_text_fill.png"]];
  ...
  [nextMonthButton setImage:[KalImageManager imageNamed:@"kal_right_arrow.png"] forState:UIControlStateNormal];
...
- (void)addSubviewsToContentView:(UIView *)contentView
{
  ...
  shadowView.image = [KalImageManager imageNamed:@"kal_grid_shadow.png"];
